...
Once the `conda-forge` channel has been enabled, `r-english` can be installed with:

```
conda install r-english
```

It is possible to list all of the versions of `r-english` available on your platform with:
